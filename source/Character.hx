...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'yt':
				// lil parrot yt ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/Lil_Parrot_YT', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'Doom', 24);
				animation.addByPrefix('singUP', 'Pain', 24);
				animation.addByPrefix('singRIGHT', 'Horrifying', 24);
				animation.addByPrefix('singDOWN', 'Suffering', 24);
				animation.addByPrefix('singLEFT', 'Agony', 24);
				...
				frames = tex;
				animation.addByPrefix('idle', 'Nard Idle', 24);
				animation.addByPrefix('singUP', 'Nard Up', 24);
				animation.addByPrefix('singRIGHT', 'Nard Right', 24);
				animation.addByPrefix('singDOWN', 'Nard Down', 24);
			    animation.addByPrefix('singLEFT', 'Nard Left', 24);
			...
			case 'block-guy':
				...
				animation.addByPrefix('singUP', 'Block Guy UP', 24);
				animation.addByPrefix('singRIGHT', 'Block Guy RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Block Guy DOWN', 24);
				animation.addByPrefix('singLEFT', 'Block Guy LEFT', 24);
			...
			case 'en-and-charlie':
				frames = Paths.getSparrowAtlas('characters/Charlie_And_En_Duet');
				animation.addByPrefix('idle', 'DuetIdle', 24, false);
				...
				animation.addByPrefix('singUP-alt', 'CharlieUp', 24, false);
				animation.addByPrefix('singDOWN-alt', 'CharlieDown', 24, false);
				animation.addByPrefix('singLEFT-alt', 'CharlieLeft', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'CharlieRight', 24, false);
