...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var leftIcon:ChartingIcon;
	var rightIcon:ChartingIcon;
	...
	override function create()
	{
		...
		leftIcon = new ChartingIcon(_song.player1);
		rightIcon = new ChartingIcon(_song.player2);
	...
	var noteType:FlxUINumericStepper;
	...
	function addNoteUI():Void
	{
		...
		noteType = new FlxUINumericStepper(10, 30, 1, 1, 0, 999, 0);
		noteType.value = 0;
		noteType.name = 'note_type';

		var stepperSusLengthLabel = new FlxText(74,10,'Note Sustain Length');

		var stepperNoteTypeLabel = new FlxText(74,30,'Note Type');
